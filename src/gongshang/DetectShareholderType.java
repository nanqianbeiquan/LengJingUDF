...
public class DetectShareholderType extends UDF {
	
	
	public HashMap<String,String> gdlxMap=new HashMap<String,String>();
	public HashMap<String,String> zjlxMap=new HashMap<String,String>();
	public HashSet<String> unknownGdNameSet=new HashSet<String>();
	public static HashSet<String> unknownLabelSet=new HashSet<String>();
	
	public DetectShareholderType()
	{
	...
	public String evaluate(String gdlx,String zjlx,String gdmc)
	{
	...
	{
		DetectShareholderType udf=new DetectShareholderType();
		System.out.println(udf.evaluate("", "", "天翼视讯传媒有限公司"));
	}
